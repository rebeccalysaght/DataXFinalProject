...
# recommendation text
textLabel1 = Label(window, text="we would like to recommend you:", font=('Cooper Black', 12), bg='white', fg='red')
...
textLabel3 = Label(window, text="city:", font=('Cooper Black', 12), bg='white', fg='red')
textLabel3.place(x=60, y=220)
textLabel4 = Label(window, text="open hour:", font=('Cooper Black', 12), bg='white', fg='red')
textLabel4.place(x=60, y=240)
textLabel4_1 = Label(window, text="Monday:", font=('Arial', 11), bg='white', fg='red')
textLabel4_1.place(x=60, y=260)
textLabel4_2 = Label(window, text="Tuesday:", font=('Arial', 11), bg='white', fg='red')
textLabel4_2.place(x=60, y=280)
textLabel4_3 = Label(window, text="Wednesday:", font=('Arial', 11), bg='white', fg='red')
textLabel4_3.place(x=60, y=300)
textLabel4_4 = Label(window, text="Thursday:", font=('Arial', 11), bg='white', fg='red')
textLabel4_4.place(x=60, y=320)
textLabel4_5 = Label(window, text="Friday:", font=('Arial', 11), bg='white', fg='red')
textLabel4_5.place(x=60, y=340)
textLabel4_6 = Label(window, text="Saturday:", font=('Arial', 11), bg='white', fg='red')
textLabel4_6.place(x=60, y=360)
textLabel4_7 = Label(window, text="Sunday:", font=('Arial', 11), bg='white', fg='red')
textLabel4_7.place(x=60, y=380)
textLabel5 = Label(window, text="categories", font=('Cooper Black', 12), bg='white', fg='red')
...
var6 = StringVar()
display_detail6 = Label(window, textvariable=var6, font=('Arial', 11), bg='white', fg='red')
display_detail6.place(x=160, y=320)

var7 = StringVar()
display_detail7 = Label(window, textvariable=var7, font=('Arial', 11), bg='white', fg='red')
display_detail7.place(x=160, y=340)

var8 = StringVar()
display_detail8 = Label(window, textvariable=var8, font=('Arial', 11), bg='white', fg='red')
display_detail8.place(x=160, y=360)

var9 = StringVar()
display_detail9 = Label(window, textvariable=var9, font=('Arial', 11), bg='white', fg='red')
display_detail9.place(x=160, y=380)

var10 = StringVar()
display_detail9 = Label(window, textvariable=var10, font=('Arial', 11), bg='white', fg='red')
display_detail9.place(x=160, y=420)

var11 = StringVar()
display_detail9 = Label(window, textvariable=var11, font=('Arial', 11), bg='white', fg='red')
