...
# user information
Label(window, text='User ID: ', font=('Cooper Black', 12), fg='red').place(x=80, y=110)
Label(window, text='Password: ', font=('Cooper Black', 12), fg='red').place(x=80, y=150)
...
check = Checkbutton(window, text="remember the password", font=('Cooper Black', 12), fg='red')
check.place(x=80, y=190)

# login display
var = StringVar()
display_name = Label(window, textvariable=var, fg='red', font=('Cooper Black', 15))
...
btn_login = Button(window, text='Login', font=('Cooper Black', 13), fg='red', command=hit_me)
btn_login.place(x=220, y=240)
new_user = Button(window, text="I'm a new user", font=('Cooper Black', 13), fg='red')
